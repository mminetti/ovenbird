...
public class ListUsers(IMessageBus bus) : Endpoint<ListUsersRequest, ListUsersResponse, ListUsersMapper>
{
    ...
    public override void Configure()
    {
        ...
        Summary(s =>
        {
            ...
            s.Params["search"] = string.Format(Endpoints.ParamSearch, "name and email");
    ...
    : Mapper<ListUsersRequest, ListUsersResponse, ItemPagedResult<UserDto>>
{
    ...
    {
        var items = e.Items
            .Select(u => new UserRecord(u.Id, u.Name, u.Email, u.IsActive, u.LastModifiedAtUtc, u.LastModifiedBy))
            .ToList();
