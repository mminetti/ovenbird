...
// per page as its page ships — no other wiring needed.
export const NAV_SECTIONS: NavSection[] = [
	{
		label: 'Settings',
		icon: 'i-lucide-settings',
		items: [
			{ label: 'Configurations', icon: 'i-lucide-sliders-horizontal', to: '/settings/configurations', permission: 'configurations.read' },
			{ label: 'Connectors', icon: 'i-lucide-plug', to: '/settings/connectors', permission: 'connectors.read' },
			{ label: 'Companies', icon: 'i-lucide-building-2', to: '/settings/companies', permission: 'companies.read' },
			{ label: 'Markets', icon: 'i-lucide-landmark', to: '/settings/markets', permission: 'markets.read' }
		]
	},
	{
		label: 'Security',
