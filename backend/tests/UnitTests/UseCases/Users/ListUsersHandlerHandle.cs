...
public class ListUsersHandlerHandle
{
    ...
    public async Task ReturnsSuccessWithPagedResults()
    {
        ...
        {
            new(1, "Alice", "alice@example.com", "alice-ext", true, DateTimeOffset.UtcNow, "seed"),
            new(2, "Bob", "bob@example.com", "bob-ext", false, DateTimeOffset.UtcNow, "seed"),
        };
    ...
    {
        var pagedResult = new ItemPagedResult<UserDto>([], 1, Constants.Pagination.DefaultPageSize, 0, 0);
