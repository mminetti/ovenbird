using Ovenbird.Core.Interfaces;
using Ovenbird.Core.Services;
using Ovenbird.Infrastructure.Data;
using Ovenbird.Infrastructure.Data.Queries;
using Ovenbird.UseCases.Contributors.List;

namespace Ovenbird.Infrastructure;
